...
export class FullMedSearch extends React.Component {
    ...
    componentDidMount() {
        ...
        // this.repo.getFlagID(medicationID)
        //     .then(data => {
        //         const res = data.data;
        //         this.setState({flags: res});
        // })
}

    // flagMed(medicationID) {

    //         this.repo.updateFlagType(flags.flagID)
    //             .then(x => {
                                    ...
                                    <td className="text-center" scope="row" id="save">
                                        {
                                            ...
                                            <button className="btn btn-secondary" onClick = {() => this.flagID(currMed.medicationID)}>
